...
public class FriendsListFragment extends BaseFragment {
    ...
    private class GetFriends extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String friendsURL = "https://students.mimuw.edu.pl/~mk394389/buwing/friends_info.php";
    ...
    private class DeleteFriendTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            String confirmURL = "http://students.mimuw.edu.pl/~mk394389/buwing/delete_friend.php";
            URLConnection conn;
